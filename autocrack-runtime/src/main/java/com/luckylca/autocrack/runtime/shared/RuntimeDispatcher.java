...
public final class RuntimeDispatcher {
    ...
    public static JSONObject capabilities() throws Exception {
        ...
        for (String capability : List.of(
                ...
                "memory.maps","memory.modules","memory.read","memory.native.probe","memory.dladdr","memory.module.dump","memory.module.file_dump","memory.dex.list","memory.dex.dump","memory.assets.list","memory.assets.pull","memory.xml.pull","memory.xml.binary","memory.apk.entries","memory.apk.pull",
