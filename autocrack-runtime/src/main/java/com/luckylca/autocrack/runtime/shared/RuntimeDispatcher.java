...
public final class RuntimeDispatcher {
    ...
    public static JSONObject capabilities() throws Exception {
        ...
        JSONArray partial = new JSONArray()
                ...
                .put(new JSONObject().put("capability","memory.xml.block_probe").put("reason","XmlResourceParser/XmlBlock object-shape probing plus opt-in native backend table discovery and isolated APK-backed ResXMLTree replay are supported; extraction of an existing object's hidden mNative/mParseState peer remains version-gated"))
