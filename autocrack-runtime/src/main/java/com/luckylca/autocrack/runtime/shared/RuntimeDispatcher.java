...
public final class RuntimeDispatcher {
    ...
    public static JSONObject capabilities() throws Exception {
        ...
        for (String capability : List.of(
                ...
                "control.secure.status","control.secure.diagnose","control.secure.disable","control.so.inject","control.so.dlopen","control.so.android_dlopen_ext","control.so.dlsym","control.activity.start","control.process.kill","control.object.field.set","control.object.method.call",
