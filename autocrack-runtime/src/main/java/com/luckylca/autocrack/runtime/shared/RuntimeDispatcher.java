...
public final class RuntimeDispatcher {
    ...
    public static JSONObject capabilities() throws Exception {
        ...
        JSONArray partial = new JSONArray()
                ...
                .put(new JSONObject().put("capability","memory.dex.art_dump").put("reason","bounded raw export is supported only for high-confidence validated ART candidates within the 4 MiB inline cap; unbounded/chunked streaming remains unsupported"))
