...
def main():
    ...
    manifest = {
        ...
        "requires": {"runtime": ">=1.0.0", "capabilities": ["ui.windows", "ui.tree", "ui.at", "ui.props", "ui.listeners", "ui.stack", "ui.image", "ui.action", "ui.compose.status", "object.describe"], "commands": ["android-shell"], "optionalCapabilities": ["ui.compose.tree"]}
    }
