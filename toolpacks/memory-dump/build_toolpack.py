...
def main():
    ...
    manifest = {
        ...
        "selfTests": [{"id": "memory-dump-help", "title": "AutoCrack Memory Dump CLI surface", "command": f"{pack_root}/bin/memory-dump --help", "expectedExitCodes": [0], "outputContains": ["maps", "dex-art-dump", "dex-dump", "assets-list"]}],
