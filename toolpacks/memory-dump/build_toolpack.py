...
def main():
    ...
    manifest = {
        ...
        "requires": {"runtime": ">=1.0.0", "capabilities": ["memory.maps", "memory.modules", "memory.read", "memory.module.dump", "memory.dex.list", "memory.dex.dump", "memory.assets.list", "memory.assets.pull", "memory.xml.pull", "memory.apk.entries", "memory.apk.pull"], "commands": ["android-shell"], "optionalCapabilities": ["memory.xml.binary", "memory.dex.art_pointer"]}
    }
