...
def main():
    ...
    manifest = {
        ...
        "selfTests": [{"id": "runtime-control-help", "title": "AutoCrack Runtime Control CLI surface", "command": f"{pack_root}/bin/runtime-control --help", "expectedExitCodes": [0], "outputContains": ["webview-debug", "secure-diagnose", "secure-disable", "so-diagnose", "activity-start"]}],
