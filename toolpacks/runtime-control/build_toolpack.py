...
def main():
    ...
    manifest = {
        ...
        "requires": {"runtime": ">=1.0.0", "capabilities": ["control.activity.start", "control.process.kill", "control.so.inject", "control.secure.status", "control.secure.disable", "control.object.field.set", "control.object.method.call", "webview.list", "webview.info", "webview.debug", "webview.eval"], "commands": ["android-shell"], "optionalCapabilities": ["webview.devtools_socket", "control.so.dlopen_namespace"]}
    }
