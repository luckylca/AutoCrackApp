...
copy_doc_if_present scripts/verify_mobile_agent_runtime_e2e_on_device.sh "$OUT/scripts/verify_mobile_agent_runtime_e2e_on_device.sh"
...

{
  ...
  echo '- scripts/verify_mobile_agent_runtime_e2e_on_device.sh validates the current Pi-style Mobile Agent path, Runtime Binder handshake/direct delivery, and MIUI Greeze thaw compatibility.'
